...
parser.add_argument('--data_path', type=str, default='train_dataset30.csv', help='location of the data file')
...
parser.add_argument('--pred_len', type=int, default=1, help='prediction sequence length, horizon')
    ...
    for ii in range(args.itr):
        ...
        for i in range(len(date_range1)):
            for j in range(1):
                ...
                #model_lens = [[144, 72, 30], [192, 96, 30], [96, 48, 30]]
